...
import { getSecurityCategoryLabel, getSecuritySeverityLabel } from '../../../lib/i18n-labels';
    ...
    <>
      ...
      <div className="grid grid-cols-2 gap-2">
        <Card className="p-3 text-center">
          <div className={`text-lg font-semibold ${SECURITY_SEVERITY_COLORS[idea.severity]}`}>
            {getSecuritySeverityLabel(t, idea.severity)}
          </div>
        ...
        <Card className="p-3 text-center">
          ...
          <div className="text-xs text-muted-foreground">{t('ideation.detail.files', { defaultValue: 'Files' })}</div>
        </Card>
      </div>
      ...
      <div>
        ...
        <Badge variant="outline">
          {getSecurityCategoryLabel(t, idea.category)}
        </Badge>
      </div>
      ...
      {idea.vulnerability && (
        <div>
          <h3 className="text-sm font-medium mb-2 flex items-center gap-2">
            ...
            {t('ideation.detail.vulnerability', { defaultValue: 'Vulnerability' })}
          </h3>
      ...
      <div>
        <h3 className="text-sm font-medium mb-2 flex items-center gap-2">
          ...
          {t('ideation.detail.currentRisk', { defaultValue: 'Current Risk' })}
        </h3>
      ...
      <div>
        <h3 className="text-sm font-medium mb-2 flex items-center gap-2">
          ...
          {t('ideation.detail.remediation', { defaultValue: 'Remediation' })}
        </h3>
      ...
      {idea.references && idea.references.length > 0 && (
        <div>
          <h3 className="text-sm font-medium mb-2 flex items-center gap-2">
            ...
            {t('ideation.detail.references', { defaultValue: 'References' })}
          </h3>
          <ul className="space-y-1">
      ...
      {idea.compliance && idea.compliance.length > 0 && (
        <div>
          <h3 className="text-sm font-medium mb-2">{t('ideation.detail.compliance', { defaultValue: 'Compliance' })}</h3>

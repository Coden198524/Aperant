...
import { getIdeationEffortLabel } from '../../../lib/i18n-labels';
  ...
  return (
    <>
      ...
      {idea.buildsUpon && idea.buildsUpon.length > 0 && (
        <div>
          <h3 className="text-sm font-medium mb-2 flex items-center gap-2">
            ...
            {t('ideation.detail.buildsUpon', { defaultValue: 'Builds Upon' })}
          </h3>
      ...
      {idea.implementationApproach && (
        <div>
          <h3 className="text-sm font-medium mb-2 flex items-center gap-2">
            ...
            {t('ideation.detail.implementationApproach', { defaultValue: 'Implementation Approach' })}
          </h3>
      ...
      {idea.existingPatterns && idea.existingPatterns.length > 0 && (
        <div>
          <h3 className="text-sm font-medium mb-2">{t('ideation.detail.patternsToFollow', { defaultValue: 'Patterns to Follow' })}</h3>
          <ul className="space-y-1">

...
export function createHookProxy(
  ...
  return {
    ...
    get showYunxiaoToken() { return hookRef.current.showYunxiaoToken; },
    get setShowYunxiaoToken() { return hookRef.current.setShowYunxiaoToken; },
    ...
    get showYunxiaoImportModal() { return hookRef.current.showYunxiaoImportModal; },
    get setShowYunxiaoImportModal() { return hookRef.current.setShowYunxiaoImportModal; },

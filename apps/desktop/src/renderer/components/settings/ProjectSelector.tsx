      ...
      >
        <SelectTrigger className="w-full [&_span]:truncate">
          <div className="flex items-center gap-2 min-w-0 flex-1 overflow-hidden">
            ...
            <SelectValue
              placeholder={t('projectSelector.selectProject', { defaultValue: 'Select a project...' })}
        ...
        <SelectContent className="min-w-(--radix-select-trigger-width) max-w-(--radix-select-trigger-width)">
          {projects.length === 0 ? (
            <div className="px-2 py-4 text-center text-sm text-muted-foreground">
              <p>{t('projectSelector.empty', { defaultValue: 'No projects yet' })}</p>
            </div>
          ) : (
          ...
          <SelectItem value="__add_new__">
            <div className="flex items-center gap-2">
              ...
              <span>{t('projectSelector.addProject', { defaultValue: 'Add Project...' })}</span>
            </div>
          </SelectItem>
        </SelectContent>
      </Select>

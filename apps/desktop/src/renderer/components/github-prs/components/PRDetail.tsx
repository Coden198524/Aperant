...
export function PRDetail({
  ...
  //   - Writes logs to disk every 3 entries: .autocode/github/pr/logs_${prNumber}.json
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      const approvalMessage = `## ✅ Autocode PR Review - APPROVED\n\n${reviewResult.summary}\n\n---\n*This approval was generated by Autocode.*`;

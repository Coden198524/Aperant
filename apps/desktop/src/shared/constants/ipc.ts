...
export const IPC_CHANNELS = {
  ...
  PROJECT_REFRESH_PROMPTS: 'project:refreshPrompts',
  ...
  TASK_CREATE_PROJECT_DOCS: 'task:createProjectDocs',
  TASK_DELETE: 'task:delete',
  TASK_UPDATE: 'task:update',
  TASK_DELETE_SUBTASK: 'task:deleteSubtask',
  ...
  TASK_IMPROVE_DESCRIPTION: 'task:improveDescription',  // AI-rewrite a user's task description for precision
  TASK_GET_NEEDS_INPUT_DECISIONS: 'task:getNeedsInputDecisions',  // Parse design_review.md open-question decision options
  TASK_RESOLVE_NEEDS_INPUT_DECISIONS: 'task:resolveNeedsInputDecisions',  // Write chosen decisions back to requirements.md before re-planning
  ...
  YUNXIAO_LOAD_IMAGE: 'yunxiao:loadImage',
  YUNXIAO_GET_ISSUES: 'yunxiao:getIssues',
  YUNXIAO_SYNC_ISSUES: 'yunxiao:syncIssues',
  YUNXIAO_UPDATE_ISSUE: 'yunxiao:updateIssue',
  YUNXIAO_ANALYZE_ISSUE: 'yunxiao:analyzeIssue',
  YUNXIAO_ISSUES_UPDATED: 'yunxiao:issuesUpdated',
  YUNXIAO_AUTOFIX_GET_CONFIG: 'yunxiao:autofix:getConfig',
  YUNXIAO_AUTOFIX_SAVE_CONFIG: 'yunxiao:autofix:saveConfig',
  YUNXIAO_AUTOFIX_GET_QUEUE: 'yunxiao:autofix:getQueue',
  YUNXIAO_AUTOFIX_CHECK_NEW: 'yunxiao:autofix:checkNew',
  YUNXIAO_AUTOFIX_START: 'yunxiao:autofix:start',
  YUNXIAO_AUTOFIX_PROGRESS: 'yunxiao:autofix:progress',
  YUNXIAO_AUTOFIX_COMPLETE: 'yunxiao:autofix:complete',
  YUNXIAO_AUTOFIX_ERROR: 'yunxiao:autofix:error',
  YUNXIAO_AUTOFIX_ANALYZE_PREVIEW: 'yunxiao:autofix:analyzePreview',
  YUNXIAO_AUTOFIX_ANALYZE_PREVIEW_PROGRESS: 'yunxiao:autofix:analyzePreviewProgress',
  YUNXIAO_AUTOFIX_ANALYZE_PREVIEW_COMPLETE: 'yunxiao:autofix:analyzePreviewComplete',
  YUNXIAO_AUTOFIX_ANALYZE_PREVIEW_ERROR: 'yunxiao:autofix:analyzePreviewError',
  YUNXIAO_AUTOFIX_APPROVE_BATCHES: 'yunxiao:autofix:approveBatches',
...
// GitLab integration
  ...
  INSIGHTS_AUTHORIZE_DOCUMENT: 'insights:authorizeDocument',

...
export class ChangelogService extends EventEmitter {
   ...
   * Checks DEBUG from autocode/.env and DEBUG from process.env
   */
  ...
  /**
   * Debug logging - only logs when DEBUG=true in autocode/.env or DEBUG is set
   */

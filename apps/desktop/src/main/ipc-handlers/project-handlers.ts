...
export function registerProjectHandlers(
  ...
  // Version tracking for .autocode is removed since it only contains data
  ipcMain.handle(
      ...
      try {
        ...
        return {
          ...
          data: {
            ...
            updateAvailable: false // No updates for .autocode - it's just data
          }
        };
      } catch (error) {
        return {
  ...
  // Check if project has local autocode source (is dev project)
  ipcMain.handle(

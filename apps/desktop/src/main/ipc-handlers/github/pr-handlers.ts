 ...
 *
 * Logs are stored at `.autocode/github/pr/logs_${prNumber}.json` within the project directory.
 ...
 *    - Location: .autocode/github/pr/logs_${prNumber}.json
...
class PRLogCollector {
   ...
   *    - Creates/updates .autocode/github/pr/logs_${prNumber}.json
      ...
      const postResult = await withProjectOrNull(projectId, async (project) => {
        ...
        try {
          ...
          if (options?.forceApprove) {
            ...
            body += `*Generated by Autocode*`;
          } else {
            // Standard review format
            body = `## 🤖 Autocode PR Review\n\n${result.summary}\n\n`;
            ...
            body += `---\n*This review was generated by Autocode.*`;
          }

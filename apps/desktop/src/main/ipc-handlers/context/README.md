...
test('buildMemoryStatus returns correct status', () => {
  const status = buildMemoryStatus('/path/to/project', 'autocode');
...
- [Project Memory System](../../../../autocode/memory.py)
- [Graphiti Memory Integration](../../../../autocode/graphiti_memory.py)
